...
function btnscan1() {
    cordova.plugins.barcodeScanner.scan(
        function (escaneo) {
            var lista = "";
            lista += "<li><b>Resultado:</b> " + escaneo.text + "</li>";
            lista += "<li><b>Formato:</b> " + escaneo.format + "</li>";
...
function borrar(tipo) {
    var lista = "";
    if (tipo)
        document.getElementById("propiedades").innerHTML = lista;
    else
        document.getElementById("info").innerHTML = lista;
}
function btnpropiedades() {
    var lista = "";
    lista
        += "<li><b>Fabricante:</b> " + device.manufacturer + "</li>";
    lista
        += "<li><b>Modelo:</b> " + device.model + "</li>";
    lista
        += "<li><b>Sistema Operativo:</b> " + device.platform + "</li>";
    lista
        += "<li><b>Version S.O.:</b> " + device.version + "</li>";
    lista
        += "<li><b>Tfno IMEI:</b> " + device.uuid + "</li>";
    lista
        += "<li><b>Tfno No Serie:</b> " + device.serial + "</li>";
    lista
        += "<li><b>Version Plugin:</b> " + device.cordova + "</li>";
    document.getElementById("propiedades").innerHTML = lista;
}
